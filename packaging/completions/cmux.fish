...
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -l socket -d 'Path to the cmux socket (overrides discovery)' -r
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -l color -d 'Color mode: always, never, auto' -r
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -l json -d 'Output raw JSON responses'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -l no-json -d 'Suppress JSON output for browser commands (browser defaults to JSON)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -s v -l verbose -d 'Verbose output (connection info to stderr)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -s h -l help -d 'Print help'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "setup" -d 'Install supported hooks while preserving unrelated agent configuration'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "claude" -d 'Receive a Claude Code hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "codex" -d 'Receive a Codex lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "grok" -d 'Receive a Grok lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "gemini" -d 'Receive a Gemini lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "kiro" -d 'Receive a Kiro CLI agent hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "antigravity" -d 'Receive an Antigravity hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "copilot" -d 'Receive a GitHub Copilot lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "codebuddy" -d 'Receive a CodeBuddy lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "factory" -d 'Receive a Factory Droid lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "qoder" -d 'Receive a Qoder lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "opencode" -d 'Receive an OpenCode plugin lifecycle payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "cursor" -d 'Receive a Cursor Agent lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "pi" -d 'Receive a Pi coding agent extension lifecycle payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "omp" -d 'Receive an OMP extension lifecycle payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "campfire" -d 'Receive a Campfire extension lifecycle payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "amp" -d 'Receive an Amp plugin lifecycle payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "rovodev" -d 'Receive a Rovo Dev YAML hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
