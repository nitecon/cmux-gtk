...
complete -c cmux -n "__fish_cmux_needs_command" -f -a "comments" -d 'Manage durable diff-review comments keyed by Git repository'
complete -c cmux -n "__fish_cmux_needs_command" -f -a "project" -d 'Open a bounded manifest-aware Linux project inspector'
...
complete -c cmux -n "__fish_cmux_using_subcommand comments; and not __fish_seen_subcommand_from list add delete consume help" -l socket -d 'Path to the cmux socket (overrides discovery)' -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and not __fish_seen_subcommand_from list add delete consume help" -l color -d 'Color mode: always, never, auto' -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and not __fish_seen_subcommand_from list add delete consume help" -l json -d 'Output raw JSON responses'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and not __fish_seen_subcommand_from list add delete consume help" -l no-json -d 'Suppress JSON output for browser commands (browser defaults to JSON)'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and not __fish_seen_subcommand_from list add delete consume help" -s v -l verbose -d 'Verbose output (connection info to stderr)'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and not __fish_seen_subcommand_from list add delete consume help" -s h -l help -d 'Print help'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and not __fish_seen_subcommand_from list add delete consume help" -f -a "list" -d 'List pending review comments for a Git repository'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and not __fish_seen_subcommand_from list add delete consume help" -f -a "add" -d 'Add a durable line-anchored review comment'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and not __fish_seen_subcommand_from list add delete consume help" -f -a "delete" -d 'Delete one review comment by UUID'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and not __fish_seen_subcommand_from list add delete consume help" -f -a "consume" -d 'Mark selected or all pending comments as delivered to an agent'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and not __fish_seen_subcommand_from list add delete consume help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from list" -l repo -r -F
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from list" -l socket -d 'Path to the cmux socket (overrides discovery)' -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from list" -l color -d 'Color mode: always, never, auto' -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from list" -l all -d 'Include comments already marked consumed'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from list" -l json -d 'Output raw JSON responses'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from list" -l no-json -d 'Suppress JSON output for browser commands (browser defaults to JSON)'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from list" -s v -l verbose -d 'Verbose output (connection info to stderr)'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -l repo -r -F
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -l file -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -l side -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -l line -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -l end-line -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -l line-text -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -l message -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -l socket -d 'Path to the cmux socket (overrides discovery)' -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -l color -d 'Color mode: always, never, auto' -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -l json -d 'Output raw JSON responses'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -l no-json -d 'Suppress JSON output for browser commands (browser defaults to JSON)'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -s v -l verbose -d 'Verbose output (connection info to stderr)'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from add" -s h -l help -d 'Print help'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from delete" -l repo -r -F
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from delete" -l socket -d 'Path to the cmux socket (overrides discovery)' -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from delete" -l color -d 'Color mode: always, never, auto' -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from delete" -l json -d 'Output raw JSON responses'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from delete" -l no-json -d 'Suppress JSON output for browser commands (browser defaults to JSON)'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from delete" -s v -l verbose -d 'Verbose output (connection info to stderr)'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from delete" -s h -l help -d 'Print help'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from consume" -l repo -r -F
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from consume" -l socket -d 'Path to the cmux socket (overrides discovery)' -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from consume" -l color -d 'Color mode: always, never, auto' -r
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from consume" -l all
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from consume" -l json -d 'Output raw JSON responses'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from consume" -l no-json -d 'Suppress JSON output for browser commands (browser defaults to JSON)'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from consume" -s v -l verbose -d 'Verbose output (connection info to stderr)'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from consume" -s h -l help -d 'Print help'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from help" -f -a "list" -d 'List pending review comments for a Git repository'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from help" -f -a "add" -d 'Add a durable line-anchored review comment'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from help" -f -a "delete" -d 'Delete one review comment by UUID'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from help" -f -a "consume" -d 'Mark selected or all pending comments as delivered to an agent'
complete -c cmux -n "__fish_cmux_using_subcommand comments; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c cmux -n "__fish_cmux_using_subcommand project" -l workspace -d 'Destination workspace UUID; defaults to the caller or selected workspace' -r
complete -c cmux -n "__fish_cmux_using_subcommand project" -l surface -d 'Place the inspector immediately to the right of this surface UUID' -r
complete -c cmux -n "__fish_cmux_using_subcommand project" -l socket -d 'Path to the cmux socket (overrides discovery)' -r
complete -c cmux -n "__fish_cmux_using_subcommand project" -l color -d 'Color mode: always, never, auto' -r
complete -c cmux -n "__fish_cmux_using_subcommand project" -l focus -d 'Focus the new inspector after it opens'
complete -c cmux -n "__fish_cmux_using_subcommand project" -l no-focus -d 'Preserve the currently focused surface (the default)'
complete -c cmux -n "__fish_cmux_using_subcommand project" -l json -d 'Output raw JSON responses'
complete -c cmux -n "__fish_cmux_using_subcommand project" -l no-json -d 'Suppress JSON output for browser commands (browser defaults to JSON)'
complete -c cmux -n "__fish_cmux_using_subcommand project" -s v -l verbose -d 'Verbose output (connection info to stderr)'
complete -c cmux -n "__fish_cmux_using_subcommand project" -s h -l help -d 'Print help'
...
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -l socket -d 'Path to the cmux socket (overrides discovery)' -r
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -l color -d 'Color mode: always, never, auto' -r
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -l json -d 'Output raw JSON responses'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -l no-json -d 'Suppress JSON output for browser commands (browser defaults to JSON)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -s v -l verbose -d 'Verbose output (connection info to stderr)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -s h -l help -d 'Print help'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "setup" -d 'Install supported hooks while preserving unrelated agent configuration'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "claude" -d 'Receive a Claude Code hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "codex" -d 'Receive a Codex lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "grok" -d 'Receive a Grok lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "gemini" -d 'Receive a Gemini lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "kiro" -d 'Receive a Kiro CLI agent hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "antigravity" -d 'Receive an Antigravity hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "hermes-agent" -d 'Receive a Hermes Agent YAML hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "kimi" -d 'Receive a Kimi Code TOML hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "copilot" -d 'Receive a GitHub Copilot lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "codebuddy" -d 'Receive a CodeBuddy lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "factory" -d 'Receive a Factory Droid lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "qoder" -d 'Receive a Qoder lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "opencode" -d 'Receive an OpenCode plugin lifecycle payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "cursor" -d 'Receive a Cursor Agent lifecycle hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "pi" -d 'Receive a Pi coding agent extension lifecycle payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "omp" -d 'Receive an OMP extension lifecycle payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "campfire" -d 'Receive a Campfire extension lifecycle payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "amp" -d 'Receive an Amp plugin lifecycle payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and not __fish_seen_subcommand_from setup claude codex grok gemini kiro antigravity hermes-agent kimi copilot codebuddy factory qoder opencode cursor pi omp campfire amp rovodev help" -f -a "rovodev" -d 'Receive a Rovo Dev YAML hook payload on stdin'
...
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kiro" -l socket -d 'Path to the cmux socket (overrides discovery)' -r
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kiro" -l color -d 'Color mode: always, never, auto' -r
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kiro" -l json -d 'Output raw JSON responses'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kiro" -l no-json -d 'Suppress JSON output for browser commands (browser defaults to JSON)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kiro" -s v -l verbose -d 'Verbose output (connection info to stderr)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kiro" -s h -l help -d 'Print help'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kiro" -f -a "session-start"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kiro" -f -a "prompt-submit"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kiro" -f -a "session-end"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kiro" -f -a "stop"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kiro" -f -a "notification"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kiro" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from antigravity" -l socket -d 'Path to the cmux socket (overrides discovery)' -r
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from antigravity" -l color -d 'Color mode: always, never, auto' -r
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from antigravity" -l json -d 'Output raw JSON responses'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from antigravity" -l no-json -d 'Suppress JSON output for browser commands (browser defaults to JSON)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from antigravity" -s v -l verbose -d 'Verbose output (connection info to stderr)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from antigravity" -s h -l help -d 'Print help'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from antigravity" -f -a "session-start"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from antigravity" -f -a "prompt-submit"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from antigravity" -f -a "session-end"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from antigravity" -f -a "stop"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from antigravity" -f -a "notification"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from antigravity" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from hermes-agent" -l socket -d 'Path to the cmux socket (overrides discovery)' -r
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from hermes-agent" -l color -d 'Color mode: always, never, auto' -r
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from hermes-agent" -l json -d 'Output raw JSON responses'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from hermes-agent" -l no-json -d 'Suppress JSON output for browser commands (browser defaults to JSON)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from hermes-agent" -s v -l verbose -d 'Verbose output (connection info to stderr)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from hermes-agent" -s h -l help -d 'Print help'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from hermes-agent" -f -a "session-start"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from hermes-agent" -f -a "prompt-submit"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from hermes-agent" -f -a "session-end"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from hermes-agent" -f -a "stop"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from hermes-agent" -f -a "notification"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from hermes-agent" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kimi" -l socket -d 'Path to the cmux socket (overrides discovery)' -r
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kimi" -l color -d 'Color mode: always, never, auto' -r
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kimi" -l json -d 'Output raw JSON responses'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kimi" -l no-json -d 'Suppress JSON output for browser commands (browser defaults to JSON)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kimi" -s v -l verbose -d 'Verbose output (connection info to stderr)'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kimi" -s h -l help -d 'Print help'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kimi" -f -a "session-start"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kimi" -f -a "prompt-submit"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kimi" -f -a "session-end"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kimi" -f -a "stop"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kimi" -f -a "notification"
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from kimi" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from help" -f -a "kiro" -d 'Receive a Kiro CLI agent hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from help" -f -a "antigravity" -d 'Receive an Antigravity hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from help" -f -a "hermes-agent" -d 'Receive a Hermes Agent YAML hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand hooks; and __fish_seen_subcommand_from help" -f -a "kimi" -d 'Receive a Kimi Code TOML hook payload on stdin'
...
complete -c cmux -n "__fish_cmux_using_subcommand help; and __fish_seen_subcommand_from comments" -f -a "list" -d 'List pending review comments for a Git repository'
complete -c cmux -n "__fish_cmux_using_subcommand help; and __fish_seen_subcommand_from comments" -f -a "add" -d 'Add a durable line-anchored review comment'
complete -c cmux -n "__fish_cmux_using_subcommand help; and __fish_seen_subcommand_from comments" -f -a "delete" -d 'Delete one review comment by UUID'
complete -c cmux -n "__fish_cmux_using_subcommand help; and __fish_seen_subcommand_from comments" -f -a "consume" -d 'Mark selected or all pending comments as delivered to an agent'
...
complete -c cmux -n "__fish_cmux_using_subcommand help; and __fish_seen_subcommand_from hooks" -f -a "kiro" -d 'Receive a Kiro CLI agent hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand help; and __fish_seen_subcommand_from hooks" -f -a "antigravity" -d 'Receive an Antigravity hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand help; and __fish_seen_subcommand_from hooks" -f -a "hermes-agent" -d 'Receive a Hermes Agent YAML hook payload on stdin'
complete -c cmux -n "__fish_cmux_using_subcommand help; and __fish_seen_subcommand_from hooks" -f -a "kimi" -d 'Receive a Kimi Code TOML hook payload on stdin'
