...
check ".desktop file" grep -q '/usr/share/applications/io.cmux.App.desktop' "$FILE_LIST_FILE"
check "metainfo xml" grep -q '/usr/share/metainfo/io.cmux.App.metainfo.xml' "$FILE_LIST_FILE"
check "icon 48x48" grep -q '/usr/share/icons/hicolor/48x48/apps/io.cmux.App.png' "$FILE_LIST_FILE"
check "icon 128x128" grep -q '/usr/share/icons/hicolor/128x128/apps/io.cmux.App.png' "$FILE_LIST_FILE"
check "icon 256x256" grep -q '/usr/share/icons/hicolor/256x256/apps/io.cmux.App.png' "$FILE_LIST_FILE"
