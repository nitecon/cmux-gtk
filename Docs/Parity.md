...
This checkpoint is incomplete parity evidence until Actions passes. `last-turn` currently fails clearly because Linux does not yet record per-turn Git baselines; durable line review comments and the separate dedicated project view also remain.
