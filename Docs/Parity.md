...
| July | Workspace/surface reorder shortcuts | Batch and keyboard reorder, pane/surface move and drag topology with correct ownership, focus and remote routing. | **Partial.** Workspace batch/keyboard moves are implemented ([workspace moves](#workspace-move-shortcuts-checkpoint)); pane/surface drag and cross-pane topology remain. |
