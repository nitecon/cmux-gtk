...
| Command interface | Shared CLI argument schema, protocol validation and dispatch; completion generation imports the schema alone | `src/cli/args.rs`, `src/cli`, `src/socket`; repository Python clients share `scripts/cmux_socket_discovery.py` |
