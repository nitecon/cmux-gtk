...
| Browser adapter | Optional browser daemon, commands, previews and navigation | `src/browser.rs`, `src/browser/{discovery,transport,frames,stream,motion,metrics}.rs` |
