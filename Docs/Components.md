...
| Session/configuration | Serializable state, compatibility, buffered session serialization/loading with strict UTF-8 validation and atomic writes | `src/session.rs`, `src/config.rs`, `src/ssh_hosts.rs` |
