...
| Remote transport | SSH deployment, reconnect and stream ownership; Go PTY adapter owns native child launch, I/O, resize and teardown | `src/ssh`, `daemon/remote`, `daemon/remote/cmd/cmuxd-remote/pty.go` |
