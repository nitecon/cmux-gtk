#!/usr/bin/env python3
"""
Retained upstream split/terminal responsiveness scenarios.

These use legacy health and command contracts, not current Linux parity
evidence. Despite the historical filename, marker files do not prove pixels
were rendered or that an actual drag gesture succeeded.
...
from legacy_terminal_support import (
    clear_marker, ensure_focused_terminal, verify_terminal_responsive,
    wait_for_marker, wait_for_terminal_in_window,
)
